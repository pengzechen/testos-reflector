...
// 使用统一的系统寄存器访问宏
#define read_esr_el1()   READ_ESR_EL1()
#define read_esr_el2()   READ_ESR_EL2()
#define read_esr_el3()   READ_ESR_EL3()
#define read_hpfar_el2() READ_HPFAR_EL2()
#define read_far_el2()   READ_FAR_EL2()
#define read_hyfar_el2() READ_HPFAR_EL2()  // 注意：原代码中这个函数实际读取的是 hpfar_el2
